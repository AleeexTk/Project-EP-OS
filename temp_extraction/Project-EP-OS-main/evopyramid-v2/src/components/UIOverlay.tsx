            ...
            <div className="space-y-2">
              {Object.entries(SECTOR_COLORS).map(([sector, color]) => (
                <div key={sector} className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-full border border-black/5" style={{ backgroundColor: color }} />
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-slate-50 p-3 rounded-lg border border-slate-100">
                  ...
                  <div className="text-slate-900 font-mono capitalize font-bold" style={{ color: STATUS_COLORS[selectedNode.status] }}>
                    {selectedNode.status}
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2 text-slate-600 text-sm">
                  ...
                  <span>Sector: <span style={{ color: SECTOR_COLORS[selectedNode.sector] }} className="capitalize font-bold">{selectedNode.sector}</span></span>
                </div>
