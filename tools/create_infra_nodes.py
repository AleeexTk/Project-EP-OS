...
nodes = [
    ...
    (
        "alpha_pyramid_core/SPINE/_10_CR_GATEWAY",
        {
            "id": "cr_gateway_z10",
            "title": "CR Gateway",
            "z_level": 10,
    ...
    (
        "beta_pyramid_functional/SPINE/_8_AGENT_BUS",
        {
            "id": "agent_bus_z8",
            "title": "Agent Bus",
            "z_level": 8,
    ...
    (
        "beta_pyramid_functional/SPINE/_7_CHAOS_ENGINE",
        {
            "id": "chaos_engine",
            "title": "Chaos Engine",
            "z_level": 7,
    ...
    (
        "beta_pyramid_functional/SPINE/_6_RESOLUTION_STREAM",
        {
    ...
    (
        "beta_pyramid_functional/SPINE/_4_OBSERVER_RELAY",
        {
    ...
    (
        "alpha_pyramid_core/SPINE/_16_NEXUS_ROUTER",
        {
            "id": "nexus_router_z16",
            "title": "Nexus Router",
            "z_level": 16,
    ...
    (
        "alpha_pyramid_core/SPINE/_14_POLICY_BUS",
        {
            "id": "policy_bus_z14",
            "title": "Policy Bus",
            "z_level": 14,
    ...
    (
        "alpha_pyramid_core/RED/_12_PROVIDER_ROUTER",
        {
    ...
    (
        "gamma_pyramid_reflective/SPINE/_2_AUDIT_BRIDGE",
        {
            "id": "audit_bridge_z2",
            "title": "Audit Bridge",
            "z_level": 2,
