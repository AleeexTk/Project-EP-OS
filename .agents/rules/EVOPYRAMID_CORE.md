# EvoPyramid OS Core Architectural Rules
...
## 5. Architectural Integrity (Deduplication)
Before adding any new file or logic, check `architecture_map.json` and `solution_catalog.json`. Prefer extension/re-use over creation of new entities.

## 6. Language Protocol
- **Dialogue/Logic**: Cognitive Triad (Russian/Ukrainian/English as markers).
- **Documentation**: Official (Ukrainian).
- **Architecture/Code**: English.
